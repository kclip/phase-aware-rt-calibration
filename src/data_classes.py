...
class _MeasurementDataBase(StorableDataclass):
    ...
    normalized_measurement_noise_std: float  # Normalized measurement noise standard deviation
...
def load_measurement_data(directory) -> Union[MeasurementDataPhaseNoise, MeasurementDataPositionNoise]:
    list_filenames = os.listdir(directory)
    if f"{MeasurementDataPositionNoise.__filename__}.json" in list_filenames:
